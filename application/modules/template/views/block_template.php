...
<head>
    ...
    <title><?php echo $block_name; ?> | Home</title>
...
<header>
   <div class="container-fluid top-striped-bar">
      <div class="container">
         <nav class="navbar navbar-light navbar-expand-md">
            <div class="collapse navbar-collapse top-nav-left">
               <ul class="navbar-nav">
                  <li><a href="javascript:;">Government of West Bengal</a></li>
              </ul>
            </div>
            <div class="collapse navbar-collapse top-nav-right">
               <ul class="navbar-nav ml-auto">
                  <li><a href="#mainbody-container">Skip To Main Content</a></li>
                  <li><a href="javascript:;">A+</a></li>
                  <li><a href="javascript:;">A</a></li>
                  <li><a href="javascript:;">A-</a></li>
                  <li><a href="<?php echo base_url()?>adminportal/login/" target="_blank"><span class="glyphicon glyphicon-log-in"></span> G2G Login</a></li>
              </ul>
            </div>
         </nav> 
      </div>
   </div> <!-- End of Top Striped Bar -->
   
   <div class="container-fluid logo-department-bar">
      <div class="container">
         <div class="row">
            <div class="col-md-1">
               <a href="<?php echo base_url();?>"><img src="<?php echo base_url(); ?>assets/webdoc/images/biswabangla-logo.png" style="width:65px;" /></a>
            </div>
            <div class="col-md-8">
                  <div class="site-title-block">
                     ...
                     <div class="d-flex flex-row mt-1">
                        <div class="site-title">South 24 Parganas , WEST BENGAL <?php //echo $headerinfo->home_title; ?> </div>
                     </div>
                     <div class="d-flex flex-row mt-1">
                        <div class="site-title"><?php echo $block_name; ?> Block<?php //echo $headerinfo->home_title; ?> </div>
                     </div>
                  </div>
            </div>
            <div class="col-md-3">
   ...
   </div> <!-- End of Logo & Department -->
   <div class="container-fluid primary-menu-bar" >
      <div class="container">
                           ...
                           <?php 
                              if(count($webmenu)>0) {
                                 foreach($webmenu as $web_menu){
                                    $first_level_url =  urlofWebMenusByType($web_menu['FirstLevelMenuData'],$web_menu['FirstLevelMenuData']->page_or_link_type,$menufor,$selected_block);
                                 ...
                                 <?php 
                                    ...
                                    foreach ($web_menu['secondLevelMenu'] as $websubmenu) {
                                       $second_level_url = urlofWebMenusByType($websubmenu['secondLevelMenuData'],$websubmenu['secondLevelMenuData']->page_or_link_type,$menufor,$selected_block);
...
<!-- <header id="main-header">
   <section id="top-section">
      <div class="container">
            ...
            <div class="col-md-10 menus-block">
               ...
               <div class="row">
                  <div class="col-md-8 site-title-block">
                     ...
                     <div class="d-flex flex-row mt-1">
                        <div class="site-title"><?php echo $headerinfo->home_title; ?> </div>
                     </div>
                  </div>
                  <div class="col-md-4">
                     ...
                     <nav class="navbar navbar-icon-top navbar-expand-lg" id="primary-menu">
                        ...
                        <div class="collapse navbar-collapse" id="primaryMenuContent">
                           ...
                           <?php 
                              if(count($webmenu)>0) {
                                 foreach($webmenu as $web_menu){
                                    $first_level_url =  urlofWebMenusByType($web_menu['FirstLevelMenuData'],$web_menu['FirstLevelMenuData']->page_or_link_type,$menufor);
                                 ...
                                 <?php 
                                    ...
                                    foreach ($web_menu['secondLevelMenu'] as $websubmenu) {
                                       $second_level_url = urlofWebMenusByType($websubmenu['secondLevelMenuData'],$websubmenu['secondLevelMenuData']->page_or_link_type,$menufor);
        ...
        <div id="mainbody-container" class="blockpages">
            <?php
            if(isset($view_file))
            { 
