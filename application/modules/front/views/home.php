                ...
                <nav class="navbar navbar-default">
                    <div class="navbar-header">
                        ...
                        <a href="index.html" class="logo">
                            <img src="<?php echo base_url(); ?>/assets/img/logos/white-logo.png" alt="logo">
                        </a>
                    </div>
                    ...
                    <div class="navbar-collapse collapse" role="navigation" aria-expanded="true" id="app-navigation">
                        ...
                        <ul class="nav navbar-nav navbar-right hidden-sm hidden-xs">
                            <li>
                                <a class="btn-navbar btn btn-sm btn-white-sm-outline btn-round" href="login.html">Create Account</a>
                            </li>
                            <li>
...
<!-- Hotel alpha start -->
<div class="hotel-alpha content-area-12 home-about">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 col-lg-offset-1 col-md-6">
                <img src="<?php echo base_url(); ?>/assets/img/about2.jpg" alt="a" class="img-responsive">
            </div>
        </div>
    </div>
</div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="hotel-box">
                                    ...
                                    <div class="header clearfix">
                                        <img src="<?php echo base_url(); ?>/assets/img/room/img-1.jpg" alt="img-1" class="img-responsive">
                                    </div>
                                    ...
                                    <div class="detail clearfix">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, conser adipisic elit, sed do eiusmod tempor incididunt ut.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="hotel-box">
                                    ...
                                    <div class="header clearfix">
                                        <img src="<?php echo base_url(); ?>/assets/img/room/img-2.jpg" alt="img-2" class="img-responsive">
                                    </div>
                        ...
                        <div class="item">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="hotel-box">
                                    ...
                                    <div class="header clearfix">
                                        <img src="<?php echo base_url(); ?>/assets/img/room/img-4.jpg" alt="img-4" class="img-responsive">
                                    </div>
                        ...
                        <div class="item">
                            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                <div class="hotel-box">
                                    ...
                                    <div class="header clearfix">
                                        <img src="<?php echo base_url(); ?>/assets/img/room/img-3.jpg" alt="img-3" class="img-responsive">
                                    </div>
...
<div class="our-facilties-section content-area">
    <div class="overlay">
        <div class="container">
            <!-- Main title -->
            <div class="main-title">
            ...
            <div class="filtr-container">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 filtr-item" data-category="3, 1, 4">
                    <!-- <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/img-21.jpg" alt="img-21" class="img-responsive"></a>
                        <figcaption>
                    ...
                    <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/g1.jpg" alt="img-2" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
                    ...
                    <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/g2.jpg" alt="img-1" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 filtr-item" data-category="3, 4, 2">
                    <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/g3.jpg" alt="img-2" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
                                <h3 class="title">Double Room</h3>
                            </div>
                    ...
                    <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/g4.jpg" alt="img-1" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
                                <h3 class="title">Single Room</h3>
                            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 filtr-item" data-category="1, 4, 3">
                    <!-- <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/img-22.jpg" alt="img-14" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
                    ...
                    <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/g5.jpg" alt="img-2" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
                                <h3 class="title">Double Room</h3>
                            </div>
                    ...
                    <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/g6.jpg" alt="img-1" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
                                <h3 class="title">Single Room</h3>
                            </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 filtr-item" data-category="2, 3, 1">
                    <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/g1.jpg" alt="img-6" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
                    ...
                    <figure class="portofolio-thumb">
                        <a href="#"><img src="<?php echo base_url(); ?>/assets/img/room/g2.jpg" alt="img-4" class="img-responsive"></a>
                        <figcaption>
                            <div class="figure-content">
