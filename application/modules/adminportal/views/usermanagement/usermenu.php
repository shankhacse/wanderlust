...
<script src="<?php echo base_url();?>assets/js/admin/usermanagement/menupermission.js"></script>
                                ...
                                <div class="col-lg-3 col-lg-33 col-md-3 col-sm-3 col-xs-3 bhoechie-tab-menu">
                                    <div class="list-group">                                        
                                        <?php foreach ($userslist as $user) { ?>
                                            <a href="javascript:;" id="<?php echo $user->user_id; ?>" onclick="getUsersPermittedMenu(<?php echo $user->user_id; ?>);" class="list-group-item serviceName text-center">
                                               ...
                                               <?php if(sizeof($Menulist)>0)  {
                                                    foreach($Menulist as $firstlevel) { 
                                                        if(sizeof($firstlevel['secondLevelMenu'])>0) {  ?>
                                                            <li id="<?php echo $firstlevel['FirstLevelMenuData']->admin_menu_id;?>"><?php echo $firstlevel['FirstLevelMenuData']->name;?>  
                                                                <ul>
                                                                <?php foreach($firstlevel['secondLevelMenu'] as $second_lvl)    {     
                                                                        if(sizeof($second_lvl['thirdLevelMenu'])>0){ ?>
                                                                            <li id="<?php echo $second_lvl['secondLevelMenuData']->admin_menu_id; ?>"><?php echo $second_lvl['secondLevelMenuData']->name; ?>
                                                                                <ul>
                                                                                    <?php foreach($second_lvl['thirdLevelMenu'] as $third_lvl) { ?>                
                                                                                        <li id="<?php echo $third_lvl['thirdLevelMenuData']->admin_menu_id; ?>"><?php echo $third_lvl['thirdLevelMenuData']->name; ?></li>      
                                                                                    <?php } ?>
                                                                                </ul>
                                                                            </li>
                                                                           <?php }else{ ?>
                                                                            <li id="<?php echo $second_lvl['secondLevelMenuData']->admin_menu_id;?>"><?php echo $second_lvl['secondLevelMenuData']->name;?></li>
                                                                           <?php }
                                                                    } ?>
                                                                </ul>
                                                            </li>        
                                                                <?php }else { ?>
                                                            <li id="<?php echo $firstlevel['FirstLevelMenuData']->admin_menu_id; ?>"><?php echo$firstlevel['FirstLevelMenuData']->name; ?></li>
                                                    <?php }
                                                            }
                                                            }?> 
                                    </ul>
