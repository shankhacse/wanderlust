...
insert  into `admin_menu_master`(`admin_menu_id`,`name`,`link`,`is_submenu`,`parent_menu_id`,`srl`,`active`,`is_developer_menu`,`created_on`,`created_by`,`icon`) values (1,'User Management','#','N',0,1,1,1,'2020-06-02 23:02:46',1,'nav-icon fas fa-user'),(2,'User','user','Y',1,1,1,0,'2020-06-02 23:02:57',1,'far fa-circle nav-icon'),(3,'User Audit','useraudit','Y',1,2,1,0,'2020-06-02 23:03:38',1,'far fa-circle nav-icon'),(4,'Menu Permission','menupermission','Y',1,3,1,0,'2020-06-02 23:03:55',1,'far fa-circle nav-icon'),(5,'Master','#','N',0,2,1,0,'2020-06-02 23:04:25',1,'nav-icon fas fa-edit'),(6,'Hotel','masters/hotels','Y',5,1,1,0,'2020-06-02 23:05:39',1,'far fa-circle nav-icon'),(7,'Room Type','masters/roomtype','Y',5,2,1,0,'2020-06-02 23:06:33',1,'far fa-circle nav-icon'),(8,'Room Master','masters/room','Y',5,3,1,0,'2020-06-02 23:06:58',1,'far fa-circle nav-icon'),(9,'Room Rate','masters/addRoomrate','Y',5,4,1,0,'2020-06-02 23:07:21',1,'far fa-circle nav-icon');
